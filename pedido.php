...
<body>
    ...
    <div class="box">
        <form action="pedido.php">
            <fieldset>
                <legend><b>Fazer Pedido</b></legend>
                <br>
                <div class="inputBox">
                    <input type="text" name="id" id="id" class="inputUser" required>
                    <label for="id" class="labelInput">Codico do Pedido</label>
                </div>
                <br><br>
                ...
                <div class="inputBox">
                    ...
                    <label for="nome" class="labelInput">Solicitante</label>
                </div>
                <br><br>
                <div class="inputBox">
                    <input type="text" name="nome" id="nome" class="inputUser" required>
                    <label for="nome" class="labelInput">Despachante</label>
                </div>
                <br><br>
